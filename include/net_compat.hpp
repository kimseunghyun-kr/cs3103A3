...
// macOS / BSD
// =========================================================
#  include <netinet/in_systm.h>  // must precede <netinet/ip.h>
#  include <netinet/ip.h>        // struct ip
#  include <netinet/ip_icmp.h>   // struct icmp
#  include <netinet/tcp.h>       // struct tcphdr

// Aliases so code can use Linux-style names
using iphdr  = struct ip;
using icmphdr = struct icmp;
using tcphdr  = struct tcphdr;

// --- IP header field mappings ---
#  define ihl         ip_hl
#  define version     ip_v
#  define tos         ip_tos
...
// --- TCP header field mappings ---
#  undef check  // avoid collision with ip_sum
